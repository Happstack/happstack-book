...
<h3><a name="ixset_lens_category">`Lens` is an instance of `Category`</a></h3>
...
<h3><a name="ixset_lens_ixset">Lens for `IxSet`</a></h3>
...
<h3><a name="ixset_lens_getter">Using a getter with `IxSet`</a></h3>
...
<h3><a name="ixset_lens_insert">Inserting an element into an `IxSet`</a></h3>
...
<h3><a name="ixset_lens_delete">Deleting an element from an `IxSet`</a></h3>
...
<h3><a name="ixset_lens_setter">Using a modifier with `IxSet`</a></h3>
...
<h3><a name="ixset_partial_lens">Using `partial-lens` with `IxSet`</a></h3>
...
<h3><a name="ixset_lens_setter">Using a setter and modifier with `IxSet` in an `acid-state` event</a></h3>
